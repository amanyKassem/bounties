...

                        {
                            this.props.cartProducts ?
                                ...
                                <View>
                                    ...
                                    <View
                                        style={[styles.rowGroup, styles.bg_fyrozy, styles.Border, styles.paddingHorizontal_10, styles.paddingVertical_10, styles.marginVertical_10, styles.marginHorizontal_15]}>
